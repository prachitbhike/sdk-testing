 ...
 */
export function modelsTrainModel(
  client: SDKCore,
  request: operations.TrainModelRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.TrainModelResponse,
    | errors.ApiError
    | SDKError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.TrainModelRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.TrainModelResponse$inboundSchema, { key: "Result" }),
