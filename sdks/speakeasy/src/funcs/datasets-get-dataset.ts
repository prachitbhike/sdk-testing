 ...
 * Retrieve a dataset
 */
export function datasetsGetDataset(
  client: SDKCore,
  request: operations.GetDatasetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetDatasetResponse,
    | errors.ApiError
    | SDKError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetDatasetRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetDatasetResponse$inboundSchema, { key: "Result" }),
