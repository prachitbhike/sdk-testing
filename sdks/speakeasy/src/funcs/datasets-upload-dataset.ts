 ...
 */
export function datasetsUploadDataset(
  client: SDKCore,
  request: operations.UploadDatasetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UploadDatasetResponse,
    | errors.ApiError
    | SDKError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.UploadDatasetRequest$outboundSchema, value),
  ...
  appendForm(body, "name", payload.body.name);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.UploadDatasetResponse$inboundSchema, {
      key: "Result",
    }),
